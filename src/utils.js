...
async function uploadImage() {
    ...
    formData.append('file', fs.createReadStream('D:/Dynamic_Chat_Bot-main/src/images/option.png')); // Local path
...
async function sendCancelInteractiveMessage(to, bodyText, buttons) {
    // Ensure there's at least one button
    if (buttons.length === 0) {
        console.error('No buttons provided for interactive message.');
        return; // Exit if no buttons are provided
